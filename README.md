...
## First steps
<img align="right" src="readmeImages/New song.PNG"  width="65%" height="70%" style="margin-left:5px;"><br>
...
<img align="right" src="readmeImages/firebase.PNG"  width="75%" height="70%" style="margin-left:5px;">
...
- tempo (bpm)
- tonality: this transpose automatically all the chords
